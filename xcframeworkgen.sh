...
xcrun xcodebuild -create-xcframework -framework AliyunPlayer/iphoneos/AliyunPlayer.framework -output "AliyunPlayer.xcframework"
rm -rf AliyunPlayer
...
xcrun xcodebuild -create-xcframework -framework AliyunMediaDownloader/iphoneos/AliyunMediaDownloader.framework -output "AliyunMediaDownloader.xcframework"
